 ...
 * @author soham
 */
public class ManageProviderUserAccount extends javax.swing.JPanel {

    /**
     * Creates new form ManageProviderUserAccount
     */
    
    private JPanel workContainer;
    private Ecosystems business;
    public ManageProviderUserAccount(JPanel workContainer, Ecosystems business) {
        initComponents();
